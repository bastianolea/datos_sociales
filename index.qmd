...
fluidPage(lang = "es",
          div(
                   ...
                   markdown("En esta página se reunen conjuntos de datos sociales listos para usarse en cualquier análisis, exploración, o proceso de aprendizaje. Principalmente los uso como ejemplo en [mis clases](https://bastianolea.rbind.io/clases/) y en [mi blog de R](https://bastianolea.rbind.io/blog/)."),
                   
                   markdown("Cada conjunto de datos se aloja en un [repositorio de GitHub](https://github.com/bastianolea?tab=repositories), donde encontrarás código en el lenguaje de progamación R que obtiene, limpia y procesa los datos, junto a scripts con los que se pueden generar gráficos, tablas, análisis estadísticos y [aplicaciones interactivas](https://bastianolea.github.io/shiny_apps/)."),
                   
                   markdown("Al lado de cada conjunto de datos aparecen iconos con sus características:")
...
markdown("Si deseas aprender a analizar datos con R, [en mi sitio web](https://bastianolea.rbind.io) tengo [tutoriales para principiantes y usuarios avanzados](https://bastianolea.rbind.io/categories/tutoriales/). Además, constantemente comparto [consejos y aprendizajes](https://bastianolea.rbind.io/blog/). Siempre puedes [contactarme](https://bastianolea.rbind.io/contact/) con cualquier duda que tengas!"),

markdown("Si reutilizas estos datos, o te han servido, ¡no olvides compartir con los demás!"),

markdown("_Esta página fue [hecha con Quarto](https://bastianolea.rbind.io/blog/datos_sociales/)_")
